...
ATTRIBUTION_START = "2026-06-11"  # only bets placed on or after this date count; RESET on Story 30.1 home_win re-promotion (was 2026-06-04) — keep in lockstep with home_win.kill_criterion.attribution_start in model_registry.yaml
