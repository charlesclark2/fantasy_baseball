...
<!-- MH2-DESIGN-BLOCK
{
 ...
 "per_metric": [
  ...
  {
   "dsr": null,
   "fold_win_rate": 0.9090909090909091,
   "metric": "iso",
   "n_arms": 11,
   "n_folds": 11,
   "pbo": 0.0,
 ...
 "reason": null,
 "schema": 1,
 "source_artifact": "quant_sports_intel_models/baseball/edge_program/ablation_results/e7_12_artifacts/e7_12_slice1_summary.json",
 "status": "recovered",
 "verdict": "woba=ADD, k_pct=ADD, bb_pct=ADD, iso=ADD"
}
-->
