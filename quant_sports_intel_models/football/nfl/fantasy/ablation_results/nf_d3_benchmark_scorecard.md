...
**Generated:** 2026-07-26T21:29:49.639680+00:00 · **seasons scored:** 2019–2024 · **model:** the SHIPPED projection (slices 1/3/4/5 on), each season built from ≤season−1 data.
...
| espn | 2 | 0.744 | 0.802 | -0.059 | 2.89 | 0.577 | 0.666 |
| sleeper | 6 | 0.729 | 0.865 | -0.136 | 5.02 | 0.423 | 0.803 |
...
| espn | -0.013 | -0.107 | -0.063 | -0.053 |
| sleeper | -0.183 | -0.143 | -0.104 | -0.115 |
...
| sleeper | 87.4 | 299 | 0.729 | 0.945 | -0.216 | 14.07 | 6.04 |
...
| sleeper | 91.5 | 322 | 0.705 | 0.958 | -0.253 | 14.69 | 5.50 |
...
| sleeper | 94.8 | 366 | 0.760 | 0.824 | -0.064 | 17.54 | 14.56 |
...
| sleeper | 97.0 | 355 | 0.726 | 0.845 | -0.119 | 16.27 | 12.50 |
...
| sleeper | 95.9 | 351 | 0.714 | 0.807 | -0.093 | 16.10 | 13.33 |
| espn | 100.0 | 366 | 0.726 | 0.824 | -0.098 | 16.17 | 12.79 |
...
| sleeper | 94.1 | 352 | 0.741 | 0.813 | -0.072 | 16.84 | 13.46 |
| espn | 99.2 | 371 | 0.761 | 0.781 | -0.020 | 16.85 | 14.45 |
...
| sleeper | 451 | 0.881 | 0.888 | 0.856 | 0.880 | 0.900 |
| espn | 620 | 0.789 | 0.872 | 0.756 | 0.737 | 0.792 |
...
| ALVIN KAMARA | RB | we_higher | +1.31 |
| MATTHEW GOLDEN | WR | we_lower | -1.24 |
| LUTHER BURDEN III | WR | we_lower | -1.21 |
| BHAYSHUL TUTEN | RB | we_lower | -1.17 |
| TRAVIS HUNTER | WR | we_lower | -1.14 |
...
| player | pos | direction | gap (z) |
|--------|-----|-----------|--------:|
| ZACH ERTZ | TE | we_higher | +2.97 |
| KEENAN ALLEN | WR | we_higher | +2.74 |
| JONNU SMITH | TE | we_higher | +2.37 |
| DARREN WALLER | TE | we_higher | +2.35 |
| CHRISTIAN MCCAFFREY | RB | we_higher | +2.33 |
| JA'MARR CHASE | WR | we_higher | +2.22 |
| TREY MCBRIDE | TE | we_higher | +2.11 |
| TRAVIS HUNTER | WR | we_lower | -2.08 |
| AMON-RA ST. BROWN | WR | we_higher | +1.98 |
| JAKOBIE KEENEY-JAMES | WR | we_higher | +1.87 |
