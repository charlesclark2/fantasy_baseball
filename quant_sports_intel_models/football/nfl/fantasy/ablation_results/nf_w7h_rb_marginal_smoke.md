...
Generated 2026-08-18T01:59:43.096949+00:00 · gate position **RB** · gate league **full_ppr** · 1 folds · target `league_fantasy_points` · ranked on `crps_q199` · gated on `randomized_pit_max_decile_dev`
...
> ⚠️ **PATH PROOF (`--smoke`)** — one fold, few draws. NOT a verdict: one fold cannot select, and the reproduction identities cannot hold at reduced draws by construction.
...
| PIT moved by the recalibration | None |
| winner beats BOTH contest foils | None |
