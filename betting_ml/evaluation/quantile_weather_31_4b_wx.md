...
|------|-----------|--------------|------------|-------|
| CV MAE (q50) | ≤ 3.3251 | 3.3394 | 3.3251 | N ✗ |
| std(pred_q50) | ≥ 1.5 | 1.4265 | 0.77 | N ✗ |
| abs(mean_residual) | ≤ 0.5 | 0.3185 | — | Y ✓ |

**pct_pred_q50 > total_line_consensus**: 0.519

## Per-Fold CV Results

| Eval Year | Train N | Eval N | MAE(q50) |
|-----------|---------|--------|----------|
| 2024 | 5,970 | 2,002 | 3.2362 |
| 2025 | 7,972 | 2,026 | 3.4579 |
| 2026 | 9,998 | 792 | 3.2969 |

**Mean CV MAE (q50)**: 3.3394  |  **std(OOF pred_q50)**: 1.4265  |  **mean_residual**: -0.3185
