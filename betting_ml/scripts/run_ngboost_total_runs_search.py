...
def run_search(exclude_sequential: bool = False, mlflow_enabled: bool = True) -> None:
    ...
    # writes betting_ml/models/total_runs/dead_weight_exclude.json). The 9 market leaks
    # are already gone via _MARKET_COLS_TO_EXCLUDE (Story 30.4a).
    _dead_weight = set(load_dead_weight_exclude("total_runs"))
