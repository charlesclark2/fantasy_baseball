...
should run only AFTER the operator's close-to-kickoff P1.2 RE-FIT. Firing before that re-fit would
freeze the pre-season COLD START (2025 carry-forward — the current board has Indiana leading) into
a track record that, by design, can never be rewritten. The intended state lives in
`BOX_OPERATIONS.md §10`.
