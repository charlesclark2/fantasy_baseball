// Google's mark, inline so it survives the artifact CSP and needs no network fetch.
// Extracted from app/login/page.tsx by E9.58 — /signup and /subscribe now offer the same
// "Continue with Google" affordance, and three copies of a brand mark drift.
