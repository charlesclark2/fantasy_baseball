...
freeManifest._fixture_note =
  ...
  "entitlement envelope flipped to the freemium build's open form. No synthetic values."

writeFileSync(MANIFEST_OUT, JSON.stringify(freeManifest, null, 2) + "\n")
console.log(`wrote ${MANIFEST_OUT.split("/").pop()} — envelope opened, no synthetic values`)
